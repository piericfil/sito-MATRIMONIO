...
├── style.css               # Tutti gli stili (2138 righe)
...
| **localita.html** | Info logistiche | Carousel location, Come arrivare, Aeroporti, Hotel |
| **programma.html** | Programma giornata | Timeline evento con orari dettagliati |
